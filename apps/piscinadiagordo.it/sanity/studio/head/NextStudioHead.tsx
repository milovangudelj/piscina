...
const faviconPng =
	typeof _faviconPng === "string" ? _faviconPng : _faviconPng.src;
const faviconIco =
	typeof _faviconIco === "string" ? _faviconIco : _faviconIco.src;
const faviconSvg =
	typeof _faviconSvg === "string" ? _faviconSvg : _faviconSvg.src;
...
export function NextStudioHead(props: NextStudioHeadProps) {
	...
	return (
		<>
			...
			{referrer && (
				<meta key="referrer" name="referrer" content={referrer} />
			)}
			{title && <title>{title}</title>}
			{favicons && (
				<link key="favicon.ico" rel="icon" href={faviconIco} sizes="any" />
			)}
			{favicons && (
				<link
